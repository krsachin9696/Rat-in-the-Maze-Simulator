var maze;
  ...
  var manage=[];
      ...
      function initialize() {
        ...
        // var butti=document.getElementById("change");

        // var butid=documnet.createElement("button");
        // butid.setAttribute("class","button-73");
        // butid.setAttribute("onclick","startMove()");
        // var valId=document.createTextNode("START");
        // butid.append(valId);
        // butti.append(butid);
